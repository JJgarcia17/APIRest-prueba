...
class CorporateDetailResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return[
            ...
            'corpotate_companies' => $corporate->companies,
            'contacts_corporates' => $corporate->contacts,
            'contracts_corporates' => $corporate->contracts,
            'documents_corporate' => $corporate->documents
        ];
